...
from models.archs.colorizers.ddcolor.basicsr.archs.vgg_arch import VGGFeatureExtractor
from models.archs.colorizers.ddcolor.basicsr.utils.registry import LOSS_REGISTRY
